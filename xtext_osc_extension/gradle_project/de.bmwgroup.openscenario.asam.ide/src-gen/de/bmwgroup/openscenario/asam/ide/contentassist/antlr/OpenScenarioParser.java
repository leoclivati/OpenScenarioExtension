...
public class OpenScenarioParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OpenScenarioGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getActionDeclarationAccess().getActionNameAssignment_1(), "rule__ActionDeclaration__ActionNameAssignment_1");
			...
			builder.put(grammarAccess.getActorDeclarationAccess().getActorNameAssignment_1(), "rule__ActorDeclaration__ActorNameAssignment_1");
			...
			builder.put(grammarAccess.getStructDeclarationAccess().getStructNameAssignment_1(), "rule__StructDeclaration__StructNameAssignment_1");
			...
			builder.put(grammarAccess.getScenarioDeclarationAccess().getScenarioNameAssignment_1(), "rule__ScenarioDeclaration__ScenarioNameAssignment_1");
			...
			builder.put(grammarAccess.getFieldAccessTailAccess().getFieldAccessAssignment_1(), "rule__FieldAccessTail__FieldAccessAssignment_1");
