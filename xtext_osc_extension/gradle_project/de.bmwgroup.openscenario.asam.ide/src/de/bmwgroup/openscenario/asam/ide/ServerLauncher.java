...
/*
	public static void redirectStandardStreams() throws Exception {
		...
		if (ServerLauncher.IS_DEBUG) {
			FileOutputStream stdFileOut = new FileOutputStream((("/home/leonardo/Documents/logs/out-" + id) + ".log"));
			System.setOut(new PrintStream(stdFileOut, true));
			FileOutputStream stdFileErr = new FileOutputStream((("/home/leonardo/Documents/logs/error-" + id) + ".log"));
